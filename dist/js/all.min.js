...
!function(){"use strict";function o(o,n,e,a,i){function s(){l.login=!l.login,l.login?($("body").removeClass("page-signup"),$("body").addClass("page-signin")):($("body").removeClass("page-signin"),$("body").addClass("page-signup"))}var l=this;l.login=!0,l.changeView=s,i.$on("cfpLoadingBar:completed",function(){l.loading=!1}),i.$on("cfpLoadingBar:started",function(){l.loading=!0}),i.$on("cfpLoadingBar:loading",function(){console.log(" ----------- loading bar loading")}),$("body").removeClass("page-signup"),$("body").addClass("page-signin"),l.error={},l.login=function(a){if(a.$valid){var i={email:l.email,password:l.password};o.login(i).then(function(o){$("body").removeClass("page-signin"),n.go("home",{})})["catch"](function(o){l.error="Usuário ou Senha Inválido(s)",e(function(){delete l.error,delete l.email,delete l.password},2e3)})}}}angular.module("app").controller("AuthController",o),o.$inject=["$auth","$state","$timeout","userFactory","$scope"]}();
...
!function(){"use strict";function e(e,a){var o=this;$("body").removeClass("page-signin"),$("body").addClass("page-signup"),o.register=function(){var e={displayName:o.user_name,email:o.user_email,password:o.user_password};$auth.signup(e).then(function(e){a.go("login",{}),alert("Registro Realizado com sucesso. Você poderá se logar agora.")})["catch"](function(e){alert(e.data.error)})}}angular.module("app").controller("RegisterController",e),e.$inject=["$http","$state"]}();
